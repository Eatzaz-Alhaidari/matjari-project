        ...
        >
            <div class="flex flex-col h-full">
                ...
                <nav class="mt-10 flex-grow px-2">
                    <a class="flex items-center px-4 py-3 mt-2 text-gray-200 rounded-lg hover:bg-white/10 hover:text-white" href="{{ route('admin.dashboard') }}">
                    ...
                    <a class="flex items-center px-4 py-3 mt-2 text-gray-200 rounded-lg hover:bg-white/10 hover:text-white" href="{{ route('admin.vendors.index') }}">
                    ...
                    <a class="flex items-center px-4 py-3 mt-2 text-gray-200 rounded-lg hover:bg-white/10 hover:text-white" href="{{ route('admin.users.index') }}">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197m0 0A10.99 10.99 0 0112 10c2.67 0 5.057 1.22 6.75 3.147" /></svg>
                        <span class="mx-3 font-semibold">إدارة العملاء</span>
                    </a>

                    <a class="flex items-center px-4 py-3 mt-2 text-gray-200 rounded-lg hover:bg-white/10 hover:text-white" href="{{ route('admin.stores.index') }}">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                        <span class="mx-3 font-semibold">إدارة المتاجر</span>
                    </a>
                    <a class="flex items-center px-4 py-3 mt-2 text-gray-200 rounded-lg hover:bg-white/10 hover:text-white" href="#">
        ...
        <div class="flex flex-col flex-1 w-full transition-all duration-300" :class="{ 'lg:mr-64': sidebarOpen }">
            <header class="relative z-10 py-4 bg-white shadow-md">
                <div class="container flex items-center justify-between h-full px-6 mx-auto text-brand-blue">
                    <button @click="sidebarOpen = !sidebarOpen" class="p-1 rounded-md focus:outline-none focus:shadow-outline-purple">
                    ...
                    <div class="flex items-center">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="text-gray-700 hover:text-brand-blue">تسجيل الخروج</a>
                        </form>
                    </div>
                </div>
            </header>
