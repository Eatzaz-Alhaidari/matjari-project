    ...
    <div x-data="{ 
        ...
        <aside
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="mt-4 flex-grow px-4 space-y-2">
                    <!-- الرئيسية -->
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                ...
                                <a href="{{ route('logout.get') }}" class="flex items-center w-full gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50 rounded-xl transition-all">
