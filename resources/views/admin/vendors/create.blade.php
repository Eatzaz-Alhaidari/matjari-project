                ...
                <div class="p-6 md:p-8 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.vendors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label for="password" class="block font-medium text-sm text-gray-700">كلمة
                                    المرور</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="password_confirmation" class="block font-medium text-sm text-gray-700">تأكيد
                                    كلمة المرور</label>
