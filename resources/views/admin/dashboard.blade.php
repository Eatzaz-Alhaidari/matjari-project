<x-admin-layout>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <a href="{{ route('admin.users.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-green-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <a href="{{ route('admin.stores.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-orange-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <a href="{{ route('admin.products.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-blue-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <a href="{{ route('admin.wallets.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-purple-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <a href="{{ route('admin.reports.financial') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-indigo-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <!-- Card: Reviews -->
        <a href="{{ route('admin.reviews.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-yellow-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <!-- Card: Notifications -->
        <a href="{{ route('admin.notifications.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-pink-50 transition-all duration-300">
            <div class="flex items-center">
        ...
        <!-- Card: Complaints -->
        <a href="{{ route('admin.complaints.index') }}" class="block p-8 bg-white rounded-xl shadow-md hover:shadow-xl hover:bg-red-50 transition-all duration-300">
            <div class="flex items-center">
