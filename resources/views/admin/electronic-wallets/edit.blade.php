<x-admin-layout>
    <x-slot name="title">
        تعديل المحفظة: {{ $electronic_wallet->wallet_name }}
    </x-slot>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <!-- Header -->
                    <div class="mb-4">
                        <h2 class="text-2xl font-bold text-gray-800">تعديل المحفظة:
                            {{ $electronic_wallet->wallet_name }}</h2>
                    </div>

                    <form action="{{ route('admin.electronic-wallets.update', $electronic_wallet->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="wallet_name"
                                    value="{{ old('wallet_name', $electronic_wallet->wallet_name) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="provider"
                                    value="{{ old('provider', $electronic_wallet->provider) }}" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="merchant_number"
                                    value="{{ old('merchant_number', $electronic_wallet->merchant_number) }}" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="balance"
                                    value="{{ old('balance', $electronic_wallet->balance) }}" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                @if($electronic_wallet->wallet_logo)
                                    <div class="mb-2">
                                        <img src="{{ Storage::url($electronic_wallet->wallet_logo) }}"
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <input type="text" name="address"
                                    value="{{ old('address', $electronic_wallet->address) }}" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea name="payment_instructions" rows="3"
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ old('payment_instructions', $electronic_wallet->payment_instructions) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="payment_mode" id="payment_mode" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="manual" {{ old('payment_mode', $electronic_wallet->payment_mode) == 'manual' ? 'selected' : '' }}>يدوي (Manual)
                                    </option>
                                    <option value="api" {{ old('payment_mode', $electronic_wallet->payment_mode) == 'api' ? 'selected' : '' }}>ربط مباشر (API)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="verification_method" id="verification_method" required
                                    class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="manual" {{ old('verification_method', $electronic_wallet->verification_method) == 'manual' ? 'selected' : '' }}>يدوي (من
                                        الأدمن)</option>
                                    <option value="automatic" {{ old('verification_method', $electronic_wallet->verification_method) == 'automatic' ? 'selected' : '' }}>
                                        تلقائي (Automatic)</option>
                                </select>
                            </div>
                            ...
                            <div id="api_fields"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="api_key"
                                        value="{{ old('api_key', $electronic_wallet->api_key) }}"
                                        class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Verify API URL</label>
                                    <input type="url" name="verify_api_url"
                                        value="{{ old('verify_api_url', $electronic_wallet->verify_api_url) }}"
                                        class="w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                <label class="flex items-center space-x-3 space-x-reverse">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $electronic_wallet->is_active) ? 'checked' : '' }}
